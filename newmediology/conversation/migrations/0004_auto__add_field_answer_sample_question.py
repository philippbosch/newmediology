...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.sample_question'
        db.add_column('conversation_answer', 'sample_question', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Answer.sample_question'
        db.delete_column('conversation_answer', 'sample_question')
